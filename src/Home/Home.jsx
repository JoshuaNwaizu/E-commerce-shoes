    ...
    return (
        <main>
            <section className="  min-[1024px]:mt-24">
                <div className="  max-[320px]:ms-4 max-[320px]:me-4 max-w-5xl ms-6 me-6 pt-24 pb-20 grid gap-y-8 relative min-[576px]:grid-cols-[350px] min-[576px]:justify-center min-[1023px]:grid-cols-2 place-items-center min-[1024px]:gap-x-8  min-[1024px]:ms-auto">
                    <div className="min-[576px]:text-center min-[1024px]:text-left">
                        ...
                        <p className=" mb-8 ">
                            ...
                            Flyknit, Flywire and water resistant defender and
                            water repellent system in the upper.
                        </p>
                        <a
                            href="#"
